...
public class ClientWindow extends JFrame implements Runnable{
	...
	private void createWindow()
	{
		...
		mnFile.setBackground(new Color(169, 169, 169));
		menuBar.add(mnFile);
		
		mntmOnlineUsers = new JMenuItem("Online Users");
		mntmOnlineUsers.setBackground(new Color(135, 206, 250));
		...
		mntmExit.setBackground(new Color(135, 206, 250));
		mnFile.add(mntmExit);
		...
		history.setBackground(new Color(127, 255, 212));
			...
			public void run() {
				while(running){
					...
					if(message.startsWith("/c/")){
						...
						console("Hey " + client.getName() + ", you have successfully connected to server.\nYou have assigned ID: "
																												+ client.getId() +"\n");
